...
namespace Course
{
    public partial class Form1 : Form
    {
        ...
        public void Start_Click(object sender, EventArgs e)
        {
            ...
            if (radioButton1.Checked) { step_value = (int)stepToView.Value; }
            else if (radioButton2.Checked) { step_value = (int)stepToView.Value * 60; }
    velosity_min_value = velosity_min.Value;
            ...
            Fake_sensor.Start_Start(step_value,velosity_min_value, velosity_max_value, temperature_min_value, temperature_max_value, humidity_min_value, humidity_max_value, air_quality_min_value, air_quality_max_value);
        }
